...
! function(t, e) {
    ...
    function x(t) {
        ...
        }(), Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), new I(t)
    }
    ...
    var T = function(t, e, i) {
        ...
        H = function() {
            function w(t, e) {
                ...
                if (F++, this.lgId = F, this.el = t, this.LGel = x(t), this.generateSettings(e), this.buildModules(), this.settings.dynamic && void 0 !== this.settings.dynamicEl && !Array.isArray(this.settings.dynamicEl)) throw "When using dynamic mode, you must also define dynamicEl as an Array.";
                return this.galleryItems = this.getItems(), this.normalizeSettings(), this.init(), this.validateLicense(), this
            }
            return w.prototype.generateSettings = function(e) {
                if (this.settings = t(t({}, C), e), this.settings.isMobile && "function" == typeof this.settings.isMobile ? this.settings.isMobile() : B()) {
                ...
                if (this.lgOpened) {
                    ...
                    var e = this.mediaContainerPosition,
                        i = e.top,
                        s = e.bottom;
                    if (this.currentImageSize = E(this.items[this.index], this.outer, i + s, t && this.settings.videoMaxSize), t && this.resizeVideoSlide(this.index, this.currentImageSize), this.zoomFromOrigin && !this.isDummyImageRemoved) {
                ...
                if (void 0 === t && (t = this.settings.index), !this.lgOpened) {
                    ...
                    this.zoomFromOrigin && e && (this.currentImageSize = E(e, this.outer, d + g, h && this.settings.videoMaxSize), o = O(e, this.outer, d, g, this.currentImageSize)), this.zoomFromOrigin && o || (this.outer.addClass(this.settings.startClass), this.getSlideItem(t).removeClass("lg-complete"));
                ...
                if (".lg-item" !== this.settings.appendSubHtmlTo) i ? T(i, this.outer.find(".lg-sub-html"), "replace") : this.outer.find(".lg-sub-html").html(e);
                else {
                ...
                if (this.settings.dynamic || (s = x(this.items).eq(e)), s) {
                    ...
                    var o = this.getDummyImgStyles(this.currentImageSize),
                        r = document.createElement("img");
                    return r.alt = i || "", r.src = n, r.className = "lg-dummy-img", r.style.cssText = o, t.addClass("lg-first-slide"), this.outer.addClass("lg-first-slide-loading"), r
                }
                return ""
...
! function(t, e) {
    ...
    return function() {
        ...
        return o.prototype.init = function() {
            ...
            return o.alt = i || "", o.setAttribute("data-lg-item-id", e + ""), o.src = s, n.appendChild(o), n
            ...
            if (n.youtube) {
                ...
                var h = function(e, o) {
                    ...
                    var i = o.vimeo[2] || "",
                        ...
                        n = ((o.vimeo[0].split("/").pop() || "").split("?")[0] || "").split("#")[0],
                        l = o.vimeo[1] !== n;
                    l && (i = i.replace("/" + n, ""));
                    var d = l ? "h=" + n : "";
